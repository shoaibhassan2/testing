...
public class ConfirmationFragmentDialog extends DialogFragment implements View.OnClickListener {
    ...
    public void onClick(View view) {
        ...
        if (id == R.id.buttonOk) {
            ...
            dismiss();
            this.iConfirmationFragmentDialog.cancel();
        }
    }

    public ConfirmationFragmentDialog() {
    }

    public ConfirmationFragmentDialog(String iconType, String title, String message, String okButtonText, String cancelButtonText, IConfirmationFragmentDialog callback) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        View viewInflate = inflater.inflate(R.layout.layout_confirmation_dialog, container, false);
    ...
    private void populateViews() {
        ...
        this.buttonCancel.setText(this.cancelButtonText);
        setIcon();
    }
